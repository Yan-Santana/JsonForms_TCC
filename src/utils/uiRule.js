    ...
    elements: [
      {
        ...
        elements: [
          { type: "Control", scope: "#/properties/nomeCompleto" },
          { type: "Control", scope: "#/properties/email" },
          { type: "Control", scope: "#/properties/idade" },
          { type: "Control", scope: "#/properties/receber" },
          { type: "Control", scope: "#/properties/interesses" },
          {
            type: "Control",
